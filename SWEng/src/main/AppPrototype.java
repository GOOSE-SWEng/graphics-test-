...
//		}
	...
	private void setupMain(int i) throws FileNotFoundException {
		...
		//Add elements
		bp.setTop(hotBar);
		//bp.setCenter(GWin.creategraphicsWindow(1200,700));
		bp.setCenter(Cwin.test(i));
		//Finalise Scene
		main = new Scene(bp);
